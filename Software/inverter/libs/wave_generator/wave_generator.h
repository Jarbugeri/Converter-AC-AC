 ...
 * @warning Usado apenas na fun��o generica wave
 */
#define SINE_1F         0
#define SINE_3F         1
#define SAWTOOTH        2
...
{
    float Fs;       //!< Frequencia da integra��o do gerador
    float Ts;       //!< Periodo da integra��o do gerador
    float Delta;    //!< Passo de integra��o
    float t ;       //!< Tempo
    float Fg;       //!< Frequencia fundamental da onda gerada
    float A;        //!< Amplitude da gera��o
    int updown;  //!< Sentido da cotagem
    int type;    //!< Seleciona o tipo de onda;
